...
A few limitations should not be neglected. Some potential risk factors (e.g., race, education levels, sexual activities, drug abuse) were not included in this study. In addition, many countries lack the information on GDP per capita as well as the population, which reduces the statistical power to some extent. 
